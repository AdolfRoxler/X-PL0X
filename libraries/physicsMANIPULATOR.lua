...
if _.Obj then if isnetworkowner(_.Obj) then else continue end elseif not _.Obj:IsA("BasePart") then PhysQueue[Obj]=nil continue else PhysQueue[Obj]=nil continue end
